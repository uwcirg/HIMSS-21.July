...
new Vue({
  ...
  data: function() {
    ...
    methods: {
        ...
        logout: function() {
            window.location = "https://keycloak.cirg.washington.edu/auth/realms/ECR-WA-Notify/protocol/openid-connect/logout?redirect_uri=https%3A%2F%2Fecr.wanotify.uw.edu%2F";
        },
